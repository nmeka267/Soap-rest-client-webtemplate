package com.bankinggclient.spring.soap.api.client;
...
public class SoapClient {
	...
	public Acknowledgement getLoanStatus(CustomerRequest request) {
		...
		Acknowledgement acknowledgement = (Acknowledgement) template.marshalSendAndReceive("http://localhost:8080/webservice",
				request);
		//Soap provider  
